import { INodeType, INodeTypeDescription, NodeConnectionTypes, IExecuteFunctions, INodeExecutionData } from 'n8n-workflow';
            ...
            // Content options
            {
                ...
                options: [
                     ...
                     },
                    {
                        name: 'HTML',
                        value: 'html',
                        description: 'Return the content as HTML, a rich text format that can be rendered in a browser or an email',
                    },
                ],
                default: 'markdown',
			...
			try {
				...
				switch (action) {
					...
					case 'content':
						...
						endpoint = contentType === 'markdown' ? '/markdown' : contentType === 'html' ? '/html' : '';
						break;
